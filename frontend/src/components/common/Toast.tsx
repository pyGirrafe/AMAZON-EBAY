...
export default function Toast({ error, success, clearMessages }: ToastProps) {
    return (
        <>
            {success &&
                <div id="toast-success" className="animate-bounce fixed top-5 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-green-100 bg-opacity-75 rounded-lg shadow" role="alert">
            ...
            {error &&
                <div id="toast-danger" className="animate-bounce fixed top-5 right-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-red-400 bg-opacity-75 rounded-lg shadow" role="alert">
